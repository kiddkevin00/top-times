...
class UnconnectedAccountInfo extends Component {
  ...
  render() {
    const { isLoadingData, isAuthenticated, isMyProfile, formFullName, formTimeZone, formRole, formDob, formEmail, formPassword, formNewsletterSubscribed, dispatchResetFormState, history, isUpdatingData } = this.props;
            ...
            <div className="inputs">
              ...
              <div className="input-container">
                ...
                <DropdownDate
                  ...
                  selectedDate={formDob && format(parse(formDob, 'yyyy-MM-dd', subYears(new Date(), 18)), 'MM/dd/yyyy')} // 'yyyy-mm-dd' format only
...
const mapStateToProps = (state, ownProps) => {
  ...
  return {
    ...
    formEmail: accountInfoForm.email.dirty
      ? accountInfoForm.email.value
      : accountInfoMain.email,
