...
class UnconnectedCreateAccount extends Component {
  ...
  handleCreateAccount = event => {
    ...
    } else if (!formFullName || !formTimeZone || !formRole || !formDob || !formEmail || !formPassword) {
    ...
    return (
      <div id="create-account">
        <main>
          ...
          <h4>
            Signing up for TopTimes is fast and easy, you can start manage your time zones in a few seconds.
          </h4>
          ...
          <form>
            <div className="inputs">
              ...
              <div className="input-container">
                ...
                <TimezoneSelect id="time-zone" onChange={this.handleInputChange.bind(this, 'timeZone')} value={this.props.formTimeZone} />
              </div>
