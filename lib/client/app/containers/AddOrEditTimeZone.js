...
class UnconnectedAddOrEditTimeZone extends Component {
  ...
  render() {
    const { isAdding, isAuthenticated, formDisplayName, formCityInTimeZone, formCustomCityName, formNotes, history, isUpdatingData } = this.props;
...
const mapStateToProps = (state, ownProps) => {
  ...
  return {
    ...
    timeZoneId,
    userId,
    formDisplayName: addOrEditTimeZoneForm.displayName.dirty ? addOrEditTimeZoneForm.displayName.value : addOrEditTimeZoneMain.displayName,
    formCityInTimeZone: addOrEditTimeZoneForm.cityInTimeZone.dirty ? addOrEditTimeZoneForm.cityInTimeZone.value : addOrEditTimeZoneMain.cityInTimeZone,
    formCustomCityName: addOrEditTimeZoneForm.customCityName.dirty ? addOrEditTimeZoneForm.customCityName.value : addOrEditTimeZoneMain.customCityName,
    formNotes: addOrEditTimeZoneForm.notes.dirty ? addOrEditTimeZoneForm.notes.value : addOrEditTimeZoneMain.notes,
